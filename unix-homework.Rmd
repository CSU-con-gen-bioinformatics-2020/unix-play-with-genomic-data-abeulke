...
```
Using the 'ls' command before removing anything is a good way to make sure your code will only select the files or directories that you want to delete!
```
...
```
The read names are the same in R1 and R2. The differ at the very end where it is either /1 (R1) or /2 (R2 file)
```
